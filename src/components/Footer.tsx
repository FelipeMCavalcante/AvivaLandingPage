...
export default function Footer() {
  return (
    <>
      <div
        className='flex flex-col lg:flex-row py-28 bg-[#01C2CB] text-white relative font-light'
        id='Footer'
      >
        <div className='w-full lg:w-1/3 flex flex-col items-center lg:items-end text-center z-20'>
          <Image
          ...
          <div className='flex justify-center space-x-4 mt-4'>
            <div>
              <a target='_blank' href='https://www.instagram.com/vybbe/'>
                <svg
                  className='w-8 h-8 text-[#030303] hover:text-[#fe6150] transition-all duration-300 z-30'
            ...
            <div>
              <a target='_blank' href='https://x.com/vybbe_'>
                <svg
                  ...
                  fill='currentColor'
                >
                  <g id='Icon/redes sociais' clipPath='url(#clip0_1985_1128)'>
                    <path
                      id='Vector'
          ...
          <div className=''>
            <div className='text-sm flex items-center text-[#595959] py-3 font-poppins font-semibold'>
              Desenvolvido por:
              <span className='ml-2'>
                <a
        ...
        <div className='z--100 w-full flex flex-wrap xl:-ml-[440px] lg:-ml-[240px] lg:px-40 lg:justify-center lg:gap-6 lg:mt-10 text-[#030303] font-outfitregular font-bold'>
          ...
          <div className='w-full lg:w-1/4 flex flex-col lg:items-center text-center lg:border-r-4 lg:border-black'>
            ...
            <Link
              href='/#Projects'
              className='text-lg mt-4 hover:text-[#fe6150]'
            >
              Projetos
            </Link>
          </div>
          {/* Segundo grupo */}
          <div className='w-full lg:w-1/4 flex flex-col text-center z-10 '>
